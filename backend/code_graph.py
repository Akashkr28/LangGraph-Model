...
def classify_message(state: State):
    ...
    SYSTEM_PROMPT = """You are an AI assistant. You're job is to detect if the user query is related to coding/programming or not.
...
def coding_query(state: State):
    ...
    SYSTEM_PROMPT = """You are an expert coding assistant. Provide accurate and efficient code solutions to the user's programming queries.
...
def coding_validate_query(state: State):
    ...
    SYSTEM_PROMPT = f"""You are an expert coding assistant. Validate the accuracy of the provided code solution against the user's programming query.
